...
class Rectangle:
    ...
    def __add__(self, other):
        ...
        # Целочисленное деление вместо приведения к int()
    ...
    def __sub__(self, other):
        ...
        """
        # Взаимная замена прямоугольников большего - первым, меньшего - вторым
        if self.perimeter() < other.perimeter():
            self, other = other, self
        # Вычисление размера независимо от большего и меньшего - по абсолютной величине
