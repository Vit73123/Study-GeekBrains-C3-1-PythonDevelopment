...
__all__ = ['write_names', 'pseudo_name']
...
def pseudo_name() -> str:
    ...
    :return:
    '''
    letters_list = [choice(ascii_lowercase) if letter != 2 else choice('aeiouy') for letter in
                    range(randint(MIN_LETTERS_COUNT, MAX_LETTERS_COUNT))]
