...
class TestRectangle(unittest.TestCase):
    def test_width(self):
        r = Rectangle(5)
        self.assertEquals(r.width, 5)

    def test_height(self):
        r = Rectangle(3, 4)
        self.assertEquals(r.height, 4)

    def test_perimeter(self):
        r = Rectangle(5)
        self.assertEquals(r.perimeter(), 20)

    def test_area(self):
        r = Rectangle(3, 4)
        self.assertEquals(r.area(), 12)

    def test_addition(self):
        r1 = Rectangle(5)
        r2 = Rectangle(3, 4)
        r = r1 + r2
        self.assertEquals(r.width, 8)
        self.assertEquals(r.height, 6)
